...
start_index = 500  # Start index for the interval
end_index = 700    # End index for the interval
...
initial_guess = [0.01, 0.1, 1400, 10, 0]
...
plt.plot(fit_time, sir_odeint(fit_time, beta_fit, gamma_fit, S0_fit, I0_fit, R0_fit), '-', label='Fitted Model (Infected)')
plt.xlabel('Time')
