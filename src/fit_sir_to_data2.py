...
beta_fit, gamma_fit, S0_fit, I0_fit, R0_fit = fit_sir_model(actual_time, actual_infected_data)
...
plt.plot(actual_time, sir_odeint(actual_time, beta_fit, gamma_fit, S0_fit, I0_fit, R0_fit), '-', label='Fitted Model (Infected)')
plt.xlabel('Time')
